...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/rikkys_perfumes_nd_more?igsh=ZXBlNmhhc3dibmR1&utm_source=qr",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@rikkysperfumeandmore?_r=1&_t=ZS-96Wbg3Zj7lk",
    icon: (
